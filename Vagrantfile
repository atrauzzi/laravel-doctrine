...
Vagrant.configure("2") do |config|
  ...
  # Setup SSH Key share with host
  # This requires an /.ssh/config file with contents `host sociablegroup ForwardAgent yes` and then run cmd `ssh-add`
